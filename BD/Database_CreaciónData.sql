...
INSERT [dbo].[Empleado] ([idEmpleado], [idTipoEmpleado], [nombres], [apPaterno], [apMaterno], [nroDocumento], [estado], [usuario], [clave]) VALUES (1, 2, N'SakCode', N'Benavides', N'Benavides',N'74942834', 1, N'security', N'security')
INSERT [dbo].[Empleado] ([idEmpleado], [idTipoEmpleado], [nombres], [apPaterno], [apMaterno], [nroDocumento], [estado], [usuario], [clave]) VALUES (2, 1004, N'Arcangel', N'Carranza', N'Sopla', N'74942834', 1,  N'arcangel', N'admin2121')
SET IDENTITY_INSERT [dbo].[Empleado] OFF


SET IDENTITY_INSERT [dbo].[Usuario] ON 
INSERT [dbo].[Usuario] ([idUsuario], [usuario], [clave], [estado], [idEmpleado], [tipoUser]) VALUES (1, N'security', N'security', 1, 1, N'Administrador')
INSERT [dbo].[Usuario] ([idUsuario], [usuario], [clave], [estado], [idEmpleado], [tipoUser]) VALUES (2, N'arcangel', N'admin2121', 1, 2, N'Invitado')
